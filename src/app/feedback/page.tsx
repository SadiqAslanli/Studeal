            ...
            <header className={styles.header}>
                <div className="container">
                    <Link href="/" className={styles.backLink}>
                        <span className={styles.linkIcon}>←</span> {t.common.backHome}
                    </Link>
                        ...
                        <form onSubmit={handleSubmit} className={styles.form}>
                            <div className={styles.formRow}>
                                <div className={styles.formGroup}>
                                    <label>👤 {t.feedback.labelName}</label>
                                    <input
                                        type="text"
                                ...
                                <div className={styles.formGroup}>
                                    <label>📧 {t.feedback.labelEmail}</label>
                                    <input
                                        type="email"
                            ...
                            <div className={styles.formGroup}>
                                <label>📂 {t.feedback.labelType}</label>
                            ...
                            <div className={styles.formGroup}>
                                <label>💬 {t.feedback.labelMessage}</label>
                                <textarea
                                    rows={5}
